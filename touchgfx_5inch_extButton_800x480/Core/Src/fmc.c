...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  HAL_SDRAM_SendCommand(&hsdram1, &FMC_SDRAMCommand,SDRAM_TIMEOUT);
  ...
  HAL_SDRAM_SendCommand(&hsdram1, &FMC_SDRAMCommand,SDRAM_TIMEOUT);
   ...
   FMC_SDRAMCommand.CommandTarget=FMC_SDRAM_CMD_TARGET_BANK1;
   FMC_SDRAMCommand.AutoRefreshNumber=1;
   FMC_SDRAMCommand.ModeRegisterDefinition=(uint32_t)SDRAM_MODEREG_BURST_LENGTH_1          |	//Set burst length: 1 (can be 1/2/4/8)
